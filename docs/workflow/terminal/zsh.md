---
description: '开发团队的 zsh 配置和好用的插件、主题'
---

# zsh 配置

> 个人所有配置已上传至 [LiXiuFengV1/dotfiles | GitHub](https://github.com/LiXiuFengV1)
...
# 从 url 中加载插件
zinit snippet "https://github.com/LiXiuFengV1"
...
具体可参考 —— [开发团队的 zsh 配置文件](https://github.com/LiXiuFengV1/dotfiles/tree/main/zsh)
...
if [[ -d .git ]]; then
  ...
  if [[ $url =~ "github.com/LiXiuFengV1" ]]; then
