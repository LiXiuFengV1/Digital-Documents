...
// 对象实例
const person1 = new Person('egon')
console.log(person1) // Person {name: 'egon'}
```
...
console.log(person1.name, person2.name) // 'egon' 'egon'
```
