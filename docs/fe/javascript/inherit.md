...
const instance1 = new SubType('egon')
instance1.colors.push('black')
console.log('instance1', instance1.name) // 'egon'
console.log('instance1', instance1.colors) // ['red', 'blue', 'green', 'black']

const instance2 = new SubType('LiXiuFengV1')
console.log('instance2', instance2.name) // 'LiXiuFengV1'
...
const instance1 = new SubType('egon', 18)
instance1.colors.push('black')
console.log('instance1', instance1.colors) // ['red', 'blue', 'green', 'black']
instance1.sayName() // 'egon'
instance1.sayAge() // 18

const instance2 = new SubType('LiXiuFengV1', 27)
console.log('instance2', instance2.colors) // ['red', 'blue', 'green']
instance2.sayName() // 'LiXiuFengV1'
instance2.sayAge() // 27
```
...
修改 `instance1.name` 时，`instance2.name` 的值并未发生改变，并不是因为 `instance1` 和 `instance2` 有独立的 `name` 值，而是因为 `instance1.name = 'egon'` 是给 `instance1` 添加了 `name` 值，并非修改了原型上的 `name` 值
